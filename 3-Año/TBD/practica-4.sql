...
-- INSERT INTO PARTIDAS VALUES (DEFAULT, 1, 3, 2, '2020-11-26', 0);
-- INSERT INTO PARTIDAS VALUES (DEFAULT, 3, 2, 1, '2020-11-27', -1);
...
DROP TABLE IF NOT EXISTS MATRIMONIO;
DROP TABLE IF NOT EXISTS PERSONA;
...
INSERT INTO PERSONA VALUES ('4', 'M', '2020-11-25', '1', '2');
INSERT INTO PERSONA VALUES ('5', 'M', '2020-11-25', '1', '3');
...
SELECT NOMBRE FROM PERSONA WHERE
	(NOM_M IN (SELECT NOM_M FROM MATRIMONIO)
	AND
	NOM_P NOT IN (SELECT NOM_P FROM MATRIMONIO))
	OR
	(NOM_M IN (SELECT NOM_M FROM MATRIMONIO)
	AND
	NOM_P NOT IN (SELECT NOM_P FROM MATRIMONIO));
